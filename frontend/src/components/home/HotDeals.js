...
const HotDeals = () => {
	...
	const calculateEndDate = () => {
		...
		endDate.setDate(endDate.getDate() + 1); // Thêm 5 ngày vào thời điểm hiện tại
				...
				<div className="row">
					<div className="col-md-12">
						<div className="hot-deal">
							...
							<h2 className="text-uppercase">ƯU ĐÃI HẤP DẪN TUẦN NÀY
							</h2>
							<p>BỘ SƯU TẬP MỚI GIẢM GIÁ TỚI 50%</p>
							<a className="primary-btn cta-btn" href="/product">
								Shop now
							</a>
						</div>
					</div>

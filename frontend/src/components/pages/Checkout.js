...
const Checkout = () => {
    ...
    const handlePayment = () => {
        // Hiển thị thông báo giả lập thanh toán thành công
        alert("Thanh toán thành công!");

        // Xóa dữ liệu giỏ hàng khỏi localStorage
        localStorage.removeItem('cart');

        // Chuyển hướng về trang chính hoặc giỏ hàng rỗng sau 1.5 giây
        setTimeout(() => {
            navigate('/'); // bạn có thể đổi thành '/cart' hoặc bất kỳ trang nào
        }, 1500);
    };
